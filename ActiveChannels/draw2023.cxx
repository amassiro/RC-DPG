...
//   Pixel   Strip           EB      EE      ES      HCAL                                    DT      RPC     CSC     GEM
  ...
  // https://twiki.cern.ch/twiki/bin/view/CMS/OnlineWBActiveChannelsRun3 --> 99.88 HCAL
  
  
  
//                               {"BPIX", "FPIX", "Strip",    "EB",   "EE",    "ES",   "HCAL",    "DT",   "RPC", "CSC",  "GEM"};
  const double  efficiency[ny] = { 98.4 ,   98.8,    96,   98.79,  97.97,   99.91,      99.88 ,   99.75,   87.45,   99,  90.0 };
...
//   h_active_channel->GetYaxis()->SetRangeUser(80, 102);
  h_active_channel->GetYaxis()->SetRangeUser(80, 100);
